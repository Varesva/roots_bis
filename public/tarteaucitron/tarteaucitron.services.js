...
tarteaucitron.services.stripe = {
    ...
    "js": function () {
        "use strict";
        // document.getElementById(addingStripe), function (x) {
        //     // var id = x.getAttribute("id");
        //     // var addStripe = document.createElement('script');
        //     // addStripe.setAttribute('src', 'https://js.stripe.com/v3/' );
        //     // document.getElementById(addingStripe).appendChild(addStripe);
    ...
    //     "use strict";
    //     var id = 'stripe';
    //     tarteaucitron.fallback(['stripe'], function (elem) {
    //       return tarteaucitron.engage(id);       
...
// Google Maps embed iframe gmaps
tarteaucitron.services.maps_noapi = {
    ...
    "js": function () {
        ...
        tarteaucitron.fallback(['googlemaps_embed'], function (x) {
            ...
            return "<iframe width=\"" + width + "\" height=\"" + height + "\" src=\"" + widgetURL + "\" allowfullscreen=\"\" loading=\"lazy\" referrerpolicy=\"no-referrer-when-downgrade\"></iframe>";
        });
    },
    "fallback": function () {
        "use strict";
